        ...
        <div class="col-lg-12 col-md-12">
          <div class="mu-latest-courses-area">
            ...
            <div class="mu-title">
              ...
              <ul>
                <li><h4 style="color:white"><b>1. Register</b></h4></li>
                <li><h4 style="color:white"><b>2. Pay and take it all!</b></h4></li>
              </ul>
              ...
              <div class="col-lg-8 col-md-8 col-xs-8">
                <div class="mu-latest-course-single">
                  <figure class="mu-latest-course-img">
                    <a><img src="{{ asset('/storage/site-content/nalog-za-uplatu.jpg') }}" alt="img"></a>
                    <figcaption class="mu-latest-course-imgcaption">
                      <a >Price for all courses:</a>
                      <span><a><b>17€ </b><s>90€</s></a></span>
                    </figcaption>
                  </figure>
                </div>
              </div>
                          ...
                          paypal.Buttons({
                            ...
                            createOrder: function(data, actions) {
                              return actions.order.create({
                                purchase_units: [{"description":"Pretplata za sajt sce-kursevi.com","amount":{"currency_code":"EUR","value":17}}]
                              });
                            },
                            ...
                            onApprove: function(data, actions) {
                              return actions.order.capture().then(function(orderData) {
                                ...
                                element.innerHTML = '';
                                element.innerHTML = '<h3>Hvala na uplati! Kursevi su sada dostupni!</h3>';
                                ...
                                let _token = $('meta[name="csrf-token"]').attr('content');
                                    ...
                                    $.ajax({
                                      ...
                                      url: "/preuzimanje-placanje/dodela-prava",
                                      type:"POST",
                                      data:{
                                        id:id,
                                      },
  ...
  <!-- PayPal end script -->
                        ...
                        <a >Cena:</a>
                        <span><a><b>17 EUR</b></a></span>
                    </figcaption>

                  @else
                  <a><img style="max-height: 340px" src="{{ asset('/storage/site-content/paypal-topic.png') }}" alt="img"></a>
                  <figcaption class="mu-latest-course-imgcaption">
                    <a href="{{ route('register') }}" > <b>Registrujte</b>  /&nbsp;</a><a href="{{ route('login') }}" > <b>Prijvaite</b>  se za uplatu</a>
                  </figcaption>
