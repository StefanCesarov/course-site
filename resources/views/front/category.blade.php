...
<section id="mu-course-content">
    <div class="container">
    <div class="mu-title">
    <h2 class=''>{{ $category->name }} Courses</h2>
    <p>{{ $opisNaslova }}</p>
    </div>
    <div class="row">
       <div class="col-md-12">
                ...
                <div class="col-md-6 col-sm-6"> 
                  <article class="mu-blog-single-item">
                    ...
                    <a><b>{{ $course->broj_lekcija }}</b> Lectures</a>
                      ...
                      <a href="{{ route('course-language', $course->language['slug']) }}"><button class="mu-language-btn" >{{ $course->language['name'] }}</button></a></span></a><span class="price">
                    ...
                    <div class="mu-blog-description">
                      <p>{{ Str::limit($course->opis_naziva, 90) }}</p>
